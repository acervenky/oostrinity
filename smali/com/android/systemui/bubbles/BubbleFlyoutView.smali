...
.field private final mFlyoutTitle:Landroid/widget/TextView;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v2, Lcom/android/systemui/R$id;->bubble_flyout_title:I
    ...
    iput-object v1, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mFlyoutTitle:Landroid/widget/TextView;
...
.method hideFlyout()V
    ...
    .line 299
    invoke-static {v0}, Lcom/oneplus/systemui/bubbles/BubbleUtils;->setHintEnabled(Z)V
...
.method setCollapsePercent(F)V
    ...
    .line 318
    iget-object p1, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mFlyoutTitle:Landroid/widget/TextView;
...
.method showFlyout(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/graphics/PointF;FZILjava/lang/Runnable;)V
    .locals 2

    .line 219
    iput-boolean p5, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mArrowPointingLeft:Z

    .line 220
    iput p6, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mDotColor:I
    ...
    .line 223
    invoke-virtual {p0, p6}, Lcom/android/systemui/bubbles/BubbleFlyoutView;->setCollapsePercent(F)V

    .line 224
    invoke-virtual {p0, p6}, Landroid/widget/FrameLayout;->setAlpha(F)V

    const/4 p6, 0x0

    .line 225
    invoke-virtual {p0, p6}, Landroid/widget/FrameLayout;->setVisibility(I)V
    ...
    .line 229
    iget-object p7, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mFlyoutTitle:Landroid/widget/TextView;

    invoke-virtual {p7, p6}, Landroid/widget/TextView;->setVisibility(I)V

    .line 230
    iget-object p6, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mFlyoutTitle:Landroid/widget/TextView;

    mul-float p7, p4, v0

    float-to-int p7, p7

    iget v1, p0, Lcom/android/systemui/bubbles/BubbleFlyoutView;->mFlyoutPadding:I

    mul-int/lit8 v1, v1, 0x2

    sub-int/2addr p7, v1

    invoke-virtual {p6, p7}, Landroid/widget/TextView;->setMaxWidth(I)V
    ...
    invoke-direct {p1, p0, p3, p5}, Lcom/android/systemui/bubbles/-$$Lambda$BubbleFlyoutView$uI0YooPNkhWtu8ItqiYGpHh1GuY;-><init>(Lcom/android/systemui/bubbles/BubbleFlyoutView;Landroid/graphics/PointF;Z)V
