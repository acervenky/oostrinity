...
.method private animateInBubble(Landroid/view/View;)V
    ...
    .line 788
    invoke-virtual {p0, v1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->shouldBubbleBeVisible(I)Z
    ...
    .line 801
    invoke-virtual {p1, v5, v4, v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->scaleX(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    new-array v2, v0, [Ljava/lang/Runnable;

    .line 802
    invoke-virtual {p1, v5, v4, v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->scaleY(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    new-array v2, v0, [Ljava/lang/Runnable;

    .line 803
    invoke-virtual {p1, v3, v4, v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->alpha(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
    ...
    .line 804
    invoke-virtual {p1, v1, v2, v3}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationX(FF[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    new-array v1, v0, [Ljava/lang/Runnable;

    .line 807
    invoke-virtual {p1, v1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->start([Ljava/lang/Runnable;)V
    ...
    .line 814
    iget-object p0, p0, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->mBubbleMore:Lcom/oneplus/systemui/bubbles/OpBubbleMore;
...
.method private moveFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F)V
    ...
    .line 722
    invoke-virtual {v0, p1, p2, v2}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->property(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;

    new-array v1, v1, [Ljava/lang/Runnable;

    .line 723
    invoke-virtual {v0, v1}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->start([Ljava/lang/Runnable;)V
    ...
    .line 729
    iget-object p0, p0, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->mBubbleMoreXAnim:Landroidx/dynamicanimation/animation/SpringAnimation;
    ...
    .line 731
    iget-object p0, p0, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->mBubbleMoreYAnim:Landroidx/dynamicanimation/animation/SpringAnimation;
...
.method private setStackPosition(Landroid/graphics/PointF;)V
    ...
    .line 761
    iget-object v2, p0, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsAnimationController;->mBubbleMore:Lcom/oneplus/systemui/bubbles/OpBubbleMore;
...
.method public demagnetizeFromDismissToPoint(FFFF)V
    ...
    .line 498
    invoke-virtual {p0, v1, v2, p3, p1}, Lcom/android/systemui/bubbles/animation/StackAnimationController;->springFirstBubbleWithStackFollowing(Landroidx/dynamicanimation/animation/DynamicAnimation$ViewProperty;Landroidx/dynamicanimation/animation/SpringForce;FF)V
    ...
    .line 508
    invoke-virtual {p3, v3}, Landroidx/dynamicanimation/animation/SpringForce;->setDampingRatio(F)Landroidx/dynamicanimation/animation/SpringForce;
...
.method public magnetToDismiss(FFFLjava/lang/Runnable;)V
    ...
    iget v5, p0, Lcom/android/systemui/bubbles/animation/StackAnimationController;->mIndividualBubbleSize:I
    ...
    invoke-virtual {v2, p3}, Landroid/widget/FrameLayout;->setTranslationY(F)V
    ...
    invoke-virtual {v2, v4, p0}, Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;->translationX(F[Ljava/lang/Runnable;)Lcom/android/systemui/bubbles/animation/PhysicsAnimationLayout$PhysicsPropertyAnimator;
