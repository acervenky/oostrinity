...
.method public static init(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    invoke-virtual {p0, v1, p1, v4, v3}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    .line 88
    invoke-virtual {p1, v2}, Lcom/oneplus/util/SystemSetting;->setListening(Z)V
    ...
    const-string v6, "reverse_wireless_charging_status"
    ...
    invoke-direct/range {v3 .. v8}, Lcom/oneplus/util/OpReverseWirelessChargeUtils$2;-><init>(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;ZLandroid/content/Context;)V
    ...
    invoke-direct {p1, v0, v0, v2}, Landroid/media/SoundPool;-><init>(III)V

    sput-object p1, Lcom/oneplus/util/OpReverseWirelessChargeUtils;->mDischargingDisconnectedSound:Landroid/media/SoundPool;

    .line 104
    sget-object p1, Lcom/oneplus/util/OpReverseWirelessChargeUtils;->mDischargingDisconnectedSound:Landroid/media/SoundPool;
...
.method public static showNotification(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v7, "showNotification: show="
